...
//
//     final metaweatherModel = metaweatherModelFromJson(jsonString);

import 'dart:convert';

MetaweatherModel metaweatherModelFromJson(String str) => MetaweatherModel.fromJson(json.decode(str));

String metaweatherModelToJson(MetaweatherModel data) => json.encode(data.toJson());
...
class MetaweatherModel {
    ...
    factory MetaweatherModel.fromJson(Map<String, dynamic> json) => MetaweatherModel(
